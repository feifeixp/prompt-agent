...
export const caseCategories = [
  ...
  { id: 'commercial', label: '商业广告', icon: '💼' },
  { id: 'creative', label: '创意特效', icon: '✨' },
  { id: 'cinematic', label: '影视镜头', icon: '🎬' },
  { id: 'oneshot', label: '一镜到底', icon: '📹' },
  { id: 'editing', label: '视频编辑', icon: '✂️' },
  { id: 'music', label: '音乐卡点', icon: '🎵' },
  { id: 'extend', label: '视频延长', icon: '⏱' },
  { id: 'audio', label: '声音演绎', icon: '🔊' },
]
